...
#
# Blockdesign.tcl: Tcl script for re-creating project 'Zybo'
#
# Generated by Vivado on Tue Sep 12 21:12:24 CEST 2017
...
#
# 1. This project restoration tcl script (Blockdesign.tcl) that was generated.
#
...
#
#    "/home/daniel/Schreibtisch/Git/Zybo_Linux/Vivado/Zybo/Zybo.srcs/sources_1/bd/System/System.bd"
#    "/home/daniel/Schreibtisch/Git/Zybo_Linux/Vivado/Zybo/Zybo.srcs/sources_1/bd/System/hdl/System_wrapper.vhd"
#    "/home/daniel/Schreibtisch/Git/Zybo_Linux/Vivado/Zybo/Zybo.srcs/constrs_1/new/System.xdc"
#
#*****************************************************************************************
...
set script_file "Blockdesign.tcl"
...
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/Zybo.cache/compile_simlib/vcs" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../Zybo/Zybo.srcs/sources_1/bd/System/System.bd"]"\
 "[file normalize "$origin_dir/../Zybo/Zybo.srcs/sources_1/bd/System/hdl/System_wrapper.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../Zybo/Zybo.srcs/sources_1/bd/System/System.bd"
...
set file "$origin_dir/../Zybo/Zybo.srcs/sources_1/bd/System/hdl/System_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/../Zybo/Zybo.srcs/constrs_1/new/System.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../Zybo/Zybo.srcs/constrs_1/new/System.xdc"
set file [file normalize $file]
...
set_property "target_constrs_file" "$orig_proj_dir/Zybo.srcs/constrs_1/new/System.xdc" $obj
...
if {[string equal [get_runs -quiet Synth] ""]} {
  create_run -name Synth -part xc7z010clg400-1 -flow {Vivado Synthesis 2015} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs Synth]
  set_property flow "Vivado Synthesis 2015" [get_runs Synth]
}
...
if {[string equal [get_runs -quiet impl] ""]} {
  create_run -name impl -part xc7z010clg400-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run Synth
} else {
  set_property strategy "Vivado Implementation Defaults" [get_runs impl]
  set_property flow "Vivado Implementation 2016" [get_runs impl]
}
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run Synth
} else {
